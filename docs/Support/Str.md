...
---
> Данный Helper класс реализован для работы со строками
...
Возвращает true если строка содержит только буквенные символы, иначе
false.  
``` php 
...
Возвращает true, если строка содержит только символы пробела, иначе
false.  
``` php 
Str::isBlank(' ');
#Результат
...
Возвращает true, если строка содержит только Ascii символы, иначе
false.  
``` php 
Str::isAscii('Hello');
#Результат
...
Возвращает true если в начале строки есть указанное значение, иначе
false.  
``` php 
...
Возвращает true если в конце строки есть указанное значение, иначе
false.  
``` php 
...
Возвращает true, если строка соответствует указанному шаблону, иначе
false.  
``` php 
Str::is('foo*', 'foobar');
#Результат
...
Метод разбивает строку на коллекцию
[Boot\\Support\\Collection], используя
...
Возвращает подстроку, начинающуюся с $start и до $end, не включая
индекс, указанный в $end.  
Если $end не указан, функция извлекает оставшуюся строку. Если $end
...
буквы.  
*Также принимает массив $ignore, позволяющий перечислять слова без
заглавных букв.*  
Возвращает строку с удаленными в начале пробелами  
``` php 
...
Возвращает true, если строка содержит только телефонный номер , иначе
false  
``` php 
...
Возвращает true, если строка содержит только только E-mail адрес, иначе
false  
``` php 
